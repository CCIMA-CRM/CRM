                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="file-field input-field col s12">
                            <div class="btn">
                                <span>Archivos</span>
                                <input type="file" multiple ng-model="lead.newLead.files" id="fileInput" onchange="angular.element(this).scope().fileNameChanged(this)">
                            </div>
                    ...
                    <ul class="collection">
                        <li class="collection-item" ng-repeat="file in lead.newLead.files">
                            {{file.name}}
                            <a href="#!/agregar_cliente" class="secondary-content" ng-click="lead.removeFile($index)"><i class="material-icons">Eliminar</i></a>
                        </li>
                    </ul>
                </div>
