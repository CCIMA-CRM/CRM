...
<body ng-controller="DashboardCtrl as dashboard">
    ...
    <div class="row">
        <div class="input-field col s12">
            <input id="search" type="text" ng-model="dashboard.searchQuery">
            <label for="search">Buscar por nombre, correo o teléfono</label>
        </div>
    </div>
</div>
                        ...
                        <div class="valign-wrapper">
                            <md-menu md-offset="0 -64" ng-controller="ContactMenuCtrl as contactCtrl">
                                ...
                                <md-menu-content width="2">
                                    ...
                                    <md-menu-item>
                                        <md-button ng-click="dashboard.selectArchivos(lead.idLead, $index)">
                                            Mostrar archivos
                                        </md-button>
                                    </md-menu-item>
                                    <md-menu-item>
