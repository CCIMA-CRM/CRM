...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="media/assets/css/dropdown.css">
...
<body>
    ...
    <md-sidenav class="cc-sidenav md-sidenav-left md-whiteframe-4dp" md-component-id="left">
        ...
        <!-- <ul class="dropdown" ng-click="close()">
        ...
        <div class="header-wrap absolute w100 h100">
            <div class="row header-content">
                <div class="col s12">
                    ...
                    <h5 class="header-description blue-txt center-align">Somos el Aliado Estratégico de América.<br
                            class="desctiption-br"> Creamos Inversiones Extraordinarias</h5>
                </div>
            </div>
        </div>
    </header>
    ...
    <section>
            ...
            <div class="row">
                <div class="col s12 l3">
                    <div class="p-420">
                        ...
                        <p class="center-align">Conjunto industrial ubicado estratégicamente en una de las zonas con
                            mayor plusvalía en el estado de Querétaro, entre las carreteras Celaya-Querétaro (Libre),
                            Guanajuato-Querétaro (Cuota), en el Km. 18, Sobre el Libramiento Norponiente</p>
                    </div>
                </div>
                ...
                <div class="col s12 l3">
                    <div class="p-420">
                        ...
                        <p class="center-align">Conjunto industrial ubicado en una de las zonas con mejor accesibilidad
                            dentro de la ciudad de Querétaro; entre la carretera S.L.P.-Querétaro (Carr 57) y
                            Libramiento Norponiente, contra esquina del Polígono Empresarial Santa Rosa</p>
                    </div>
                </div>
                <div class="col s12 l3">
                    <div class="p-420">
                        ...
                        <p class="center-align">Conjunto industrial ubicado dentro del corredor espacial, con accesos
                            totalmente viables como Circuito Universidades y Carretera México-Querétaro, a 25 minutos
                            del centro de Querétaro</p>
                    </div>
                </div>
                <div class="col s12 l3">
                    <div class="p-420">
                        ...
                        <p class="center-align">Conjunto industrial ubicado estratégicamente en una de las zonas con
                            mayor accesibilidad dentro de la ciudad de Querétaro en el Km 3.7 Carretera Federal
                            Queretaro-San Miguel de Allende en la localidad de Buenavista municipio de Querétaro.</p>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col s12 m6 l3">
                    <div class="p-420">
                        ...
                        <p class="center-align">Conjunto industrial ubicado en una Parcela 61 Z-1 P1/2, Coyotillos
                            municipio del marqués</p>
                    </div>
                </div>
                ...
                <div class="col s12 m6 l3">
                    <div class="p-420">
                        ...
                        <p class="center-align">Conjunto industrial ubicado a un costado de Autopista Carr federal 57
                            fracc. 1 de la parcela 189 P-5/6 Z-1 col. La palma municipio Pedro Escobedo</p>
                    </div>
                </div>
                ...
                <div class="col s12 m6 l3">
                    <div class="p-420">
                        ...
                        <p class="center-align">Parque industrial ubicado en la carretera federal 57 Querétaro - México
                            en el Km 191 el el Municipio de El Marqués</p>
                    </div>
                </div>
        ...
        <div class="py-80 blue-grey">
            <div class="px-20 pb-80">
                <h4 class="center-align light-txt">Sabemos la importancia de una <span class="futura-med">buena
                        ubicación</span>, es por ello que cada uno de nuestros parques fue <span
                        class="futura-med">estratégicamente posicionado</span></h4>
            </div>
            <div class="row">
        ...
        <div class="py-80 cc-blue-bg">
            ...
            <div class="px-20 pb-80">
                <h4 class="center-align light-txt">Sabemos que tu plan es <span class="futura-med">crecer</span>,
                    desarrollamos proyectos modulares para que puedas expandir tu negocio en 1, 2, 3 o más naves y
                    terrenos</h4>
            </div>
        ...
        <div class="py-80 blue-grey darken-3">
            <div class="px-20 pb-80">
                <h4 class="center-align light-txt">Por primera vez el capital no es problema para ver crecer tu negocio
                </h4>
            </div>
            <div class="row">
                <div class="col s1"></div>
        ...
        <div class="footer-copyright">
            <div class="container">
                <ul class="social-icons">
                    ...
                    <li class="right">
                        <a
                            href="https://www.facebook.com/pg/GPOCCIMA/services/?service_id=2352094628174708&ref=page_internal">
