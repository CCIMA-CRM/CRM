  ...
  <p class="promo__description grey-text">¡Oferta limitada!</p>
	...
	<div class="plano_container">
		...
		<div class="">
			...
			<svg version="1.1" id="N.B.P._CALAMANDA" xmlns="http://www.w3.org/2000/svg"
				xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1366 498"
				style="enable-background:new 0 0 1366 498;" xml:space="preserve">
				<style type="text/css">
					.st0 {
						fill-rule: evenodd;
						clip-rule: evenodd;
				...
				<g id="BASE">
					<image style="overflow:visible;" width="1366" height="498"
						xlink:href="media/assets/img/navetec/app/calamanda/calamanda_1.jpg">
					</image>
				</g>
				<g id="MÓDULOS">
					<g id="ISLA_A">
						<g id="A-1_1_" ng-class="nvtCalamanda.inmovablesClassList[0]"
							ng-click="nvtCalamanda.showPropertyData(55, '1A', nvtCalamanda.inmovables[0].idProperty)">
							<polyline id="A-N1_1_" class="property pb-sprite-1"
								points="128.2,4.9 194.2,4.6 194.9,196.4 128.9,196.6 128.2,4.9 			" />
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 151.2417 14.6107)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 151.8694 192.2404)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<g>
								<text transform="matrix(3.490014e-03 1 -1 3.490014e-03 132.6675 90.7653)"
									class="st1 st2 st3">40.70</text>
							</g>
							<text transform="matrix(1 0 0 1 143.1019 103.4697)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(1 0 0 1 149.3001 76.5884)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="6.8" y="11.6" class="st4 st5 st6">1A</tspan>
								</text>
							</g>
							<g>
						...
						<g id="A-2_1_" ng-class="nvtCalamanda.inmovablesClassList[1]"
							ng-click="nvtCalamanda.showPropertyData(55, '2A', nvtCalamanda.inmovables[1].idProperty)">
							<polyline id="A-N2_1_" class="property pb-sprite-2"
								points="260.1,4.4 260.8,196.2 194.9,196.4 194.2,4.6 260.1,4.4 			" />
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 217.2076 14.3775)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 217.8343 192.0073)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<g>
								<text transform="matrix(3.490014e-03 1 -1 3.490014e-03 198.6334 90.5317)"
									class="st1 st2 st3">40.70</text>
							</g>
							<text transform="matrix(1 0 0 1 209.0672 103.2363)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(1 0 0 1 213.8909 76.5884)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="6.8" y="11.6" class="st4 st5 st6">2A</tspan>
								</text>
							</g>
						</g>
						<g id="A-3_1_" ng-class="nvtCalamanda.inmovablesClassList[2]"
							ng-click="nvtCalamanda.showPropertyData(55, '3A', nvtCalamanda.inmovables[2].idProperty)">
							<polyline id="A-N3_1_" class="property pb-sprite-1"
								points="326.1,4.2 326.8,195.9 260.8,196.2 260.1,4.4 273.1,4.4 326.1,4.2 			" />
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 283.1744 14.1454)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 283.8002 191.7761)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<g>
								<text transform="matrix(3.490014e-03 1 -1 3.490014e-03 264.5969 90.2986)"
									class="st1 st2 st3">40.70</text>
							</g>
							<text transform="matrix(1 0 0 1 275.0345 103.0044)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(1 0 0 1 279.8587 76.5884)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="6.8" y="11.6" class="st4 st5 st6">3A</tspan>
								</text>
							</g>
						</g>
						<g id="A-4_1_" ng-class="nvtCalamanda.inmovablesClassList[3]"
							ng-click="nvtCalamanda.showPropertyData(55, '4A', nvtCalamanda.inmovables[3].idProperty)">
							<polyline id="A-N4_1_" class="property pb-sprite-2"
								points="392.1,3.9 392.8,195.7 326.8,195.9 326.1,4.2 392.1,3.9 			" />
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 349.1413 13.9117)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 349.7671 191.543)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<g>
								<text transform="matrix(3.490014e-03 1 -1 3.490014e-03 330.5623 90.0664)"
									class="st1 st2 st3">40.70</text>
							</g>
							<text transform="matrix(1 0 0 1 341.0008 102.7695)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(1 0 0 1 345.8255 76.5884)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="6.8" y="11.6" class="st4 st5 st6">4A</tspan>
								</text>
							</g>
						</g>
						<g id="A-5_1_" ng-class="nvtCalamanda.inmovablesClassList[4]"
							ng-click="nvtCalamanda.showPropertyData(55, '5A', nvtCalamanda.inmovables[4].idProperty)">
							<polyline id="A-N5_1_" class="property pb-sprite-1"
								points="392.1,3.9 458,3.7 458.7,195.5 392.8,195.7 392.1,3.9 			" />
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 415.1053 13.6786)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 415.732 191.3098)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<g>
								<text transform="matrix(3.490014e-03 1 -1 3.490014e-03 396.5277 89.8332)"
									class="st1 st2 st3">40.70</text>
							</g>
							<text transform="matrix(1 0 0 1 406.9666 102.5376)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(1 0 0 1 411.7918 76.5884)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="6.8" y="11.6" class="st4 st5 st6">5A</tspan>
								</text>
							</g>
						</g>
						<g id="A-6_1_" ng-class="nvtCalamanda.inmovablesClassList[5]"
							ng-click="nvtCalamanda.showPropertyData(55, '6A', nvtCalamanda.inmovables[5].idProperty)">
							<polyline id="A-N6_1_" class="property pb-sprite-2"
								points="458,3.7 499.8,3.6 524,3.5 524.7,195.2 458.7,195.5 458,3.7 			" />
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 481.0721 13.4464)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 481.6979 191.0766)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<g>
								<text transform="matrix(3.490014e-03 1 -1 3.490014e-03 462.4955 89.6001)"
									class="st1 st2 st3">40.70</text>
							</g>
							<text transform="matrix(1 0 0 1 472.9354 102.3052)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(1 0 0 1 477.7596 76.5884)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="6.8" y="11.6" class="st4 st5 st6">6A</tspan>
								</text>
							</g>
						</g>
						<g id="A-7_1_" ng-class="nvtCalamanda.inmovablesClassList[6]"
							ng-click="nvtCalamanda.showPropertyData(55, '7A', nvtCalamanda.inmovables[6].idProperty)">
							<polyline id="A-N7_1_" class="property pb-sprite-1"
								points="590.7,195 524.7,195.2 524,3.5 590,3.2 590.7,195 			" />
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 547.0375 13.2123)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 547.6653 190.8445)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<g>
								<text transform="matrix(3.490014e-03 1 -1 3.490014e-03 528.4609 89.3689)"
									class="st1 st2 st3">40.70</text>
							</g>
							<text transform="matrix(1 0 0 1 538.9007 102.0718)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(1 0 0 1 543.7254 76.5884)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="6.8" y="11.6" class="st4 st5 st6">7A</tspan>
								</text>
							</g>
						</g>
						<g id="A-8_1_" ng-class="nvtCalamanda.inmovablesClassList[7]"
							ng-click="nvtCalamanda.showPropertyData(55, '8A', nvtCalamanda.inmovables[7].idProperty)">
							<polyline id="A-N8_1_" class="property pb-sprite-2"
								points="590,3.2 617.9,3.1 655.9,3 656.6,194.8 590.7,195 590,3.2 			" />
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 613.0049 12.9801)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 613.6312 190.6113)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<g>
								<text transform="matrix(3.490014e-03 1 -1 3.490014e-03 594.4234 89.1357)"
									class="st1 st2 st3">40.70</text>
							</g>
							<text transform="matrix(1 0 0 1 604.8665 101.8398)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(1 0 0 1 609.6927 76.5884)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="6.8" y="11.6" class="st4 st5 st6">8A</tspan>
								</text>
							</g>
						</g>
						<g id="A-9_1_" ng-class="nvtCalamanda.inmovablesClassList[8]"
							ng-click="nvtCalamanda.showPropertyData(55, '9A', nvtCalamanda.inmovables[8].idProperty)">
							<polyline id="A-N9_1_" class="property pb-sprite-1"
								points="655.9,3 721.9,2.8 722.6,194.5 656.6,194.8 655.9,3 			" />
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 678.9684 12.7465)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 679.5961 190.3782)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<g>
								<text transform="matrix(3.490014e-03 1 -1 3.490014e-03 660.3922 88.9026)"
									class="st1 st2 st3">40.70</text>
							</g>
							<text transform="matrix(1 0 0 1 670.8343 101.6089)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(1 0 0 1 675.6575 76.5884)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="6.8" y="11.6" class="st4 st5 st6">9A</tspan>
								</text>
							</g>
						</g>
						<g id="A-10_1_" ng-class="nvtCalamanda.inmovablesClassList[9]"
							ng-click="nvtCalamanda.showPropertyData(55, '10A', nvtCalamanda.inmovables[9].idProperty)">
							<polyline id="A-N10_1_" class="property pb-sprite-2"
								points="721.9,2.8 736.1,2.7 787.9,2.5 788.6,194.3 722.6,194.5 721.9,2.8 			" />
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 744.9357 12.5143)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 745.5635 190.147)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<g>
								<text transform="matrix(3.490014e-03 1 -1 3.490014e-03 726.3577 88.6704)"
									class="st1 st2 st3">40.70</text>
							</g>
							<text transform="matrix(1 0 0 1 736.8011 101.3726)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(1 0 0 1 741.6263 76.5884)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="4.1" y="11.6" class="st4 st5 st6">10A</tspan>
								</text>
							</g>
						</g>
						<g id="A-11_1_" ng-class="nvtCalamanda.inmovablesClassList[10]"
							ng-click="nvtCalamanda.showPropertyData(55, '11A', nvtCalamanda.inmovables[10].idProperty)">
							<polyline id="A-N11_1_" class="property pb-sprite-1"
								points="854.5,194.1 788.6,194.3 787.9,2.5 853.8,2.3 854.5,194.1 			" />
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 810.9021 12.2821)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 811.5289 189.9128)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<g>
								<text transform="matrix(3.490014e-03 1 -1 3.490014e-03 792.324 88.4382)"
									class="st1 st2 st3">40.70</text>
							</g>
							<text transform="matrix(1 0 0 1 802.7669 101.1421)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(1 0 0 1 807.5911 76.5884)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="4.1" y="11.6" class="st4 st5 st6">11A</tspan>
								</text>
							</g>
						</g>
						<g id="A-12_1_" ng-class="nvtCalamanda.inmovablesClassList[11]"
							ng-click="nvtCalamanda.showPropertyData(55, '12A', nvtCalamanda.inmovables[11].idProperty)">
							<polyline id="A-N12_1_" class="property pb-sprite-2"
								points="853.8,2.3 919.8,2.1 920.5,193.9 854.5,194.1 853.8,2.3 			" />
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 876.8685 12.0489)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 877.4953 189.6797)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<g>
								<text transform="matrix(3.490014e-03 1 -1 3.490014e-03 858.2894 88.2041)"
									class="st1 st2 st3">40.70</text>
							</g>
							<text transform="matrix(1 0 0 1 868.7327 100.9087)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(1 0 0 1 873.5599 76.5884)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="4.1" y="11.6" class="st4 st5 st6">12A</tspan>
								</text>
							</g>
						</g>
						<g id="A-13_1_" ng-class="nvtCalamanda.inmovablesClassList[12]"
							ng-click="nvtCalamanda.showPropertyData(55, '13A', nvtCalamanda.inmovables[12].idProperty)">
							<polyline id="A-N13_1_" class="property pb-sprite-1"
								points="986.5,193.6 920.5,193.9 919.8,2.1 985.8,1.8 986.5,193.6 			" />
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 942.832 11.8158)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 943.4597 189.4475)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<g>
								<text transform="matrix(3.490014e-03 1 -1 3.490014e-03 924.2549 87.9719)"
									class="st1 st2 st3">40.70</text>
							</g>
							<text transform="matrix(1 0 0 1 934.6995 100.6763)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(1 0 0 1 939.5257 76.5884)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="4.1" y="11.6" class="st4 st5 st6">13A</tspan>
								</text>
							</g>
						</g>
						<g id="A-14_1_" ng-class="nvtCalamanda.inmovablesClassList[13]"
							ng-click="nvtCalamanda.showPropertyData(55, '14A', nvtCalamanda.inmovables[13].idProperty)">
							<polyline id="A-N14_1_" class="property pb-sprite-2"
								points="1051.7,1.6 1052.4,193.4 986.5,193.6 985.8,1.8 1051.7,1.6 			" />
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 1008.8003 11.5807)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 1009.428 189.2143)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<g>
								<text transform="matrix(3.490014e-03 1 -1 3.490014e-03 990.2203 87.7388)"
									class="st1 st2 st3">40.70</text>
							</g>
							<text transform="matrix(1 0 0 1 1000.6663 100.4443)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(1 0 0 1 1005.4925 76.5884)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="4.1" y="11.6" class="st4 st5 st6">14A</tspan>
								</text>
							</g>
						</g>
						<g id="A-15_1_" ng-class="nvtCalamanda.inmovablesClassList[14]"
							ng-click="nvtCalamanda.showPropertyData(55, '15A', nvtCalamanda.inmovables[14].idProperty)">
							<polyline id="A-N15_1_" class="property pb-sprite-1"
								points="1051.7,1.6 1117.7,1.4 1118.4,193.2 1052.4,193.4 1051.7,1.6 			" />
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 1074.7667 11.3485)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 1075.3944 188.9831)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<g>
								<text transform="matrix(3.490014e-03 1 -1 3.490014e-03 1056.1866 87.5066)"
									class="st1 st2 st3">40.70</text>
							</g>
							<text transform="matrix(1 0 0 1 1066.6332 100.2114)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(1 0 0 1 1071.4594 76.5884)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="4.1" y="11.6" class="st4 st5 st6">15A</tspan>
								</text>
							</g>
						</g>
						<g id="A-16_1_" ng-class="nvtCalamanda.inmovablesClassList[15]"
							ng-click="nvtCalamanda.showPropertyData(55, '16A', nvtCalamanda.inmovables[15].idProperty)">
							<polyline id="A-N16_1_" class="property pb-sprite-2"
								points="1183.7,1.1 1184.4,192.9 1118.4,193.2 1117.7,1.4 1183.7,1.1 			" />
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 1140.7311 11.1154)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 1141.3589 188.749)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<g>
								<text transform="matrix(3.490014e-03 1 -1 3.490014e-03 1122.1462 87.2739)"
									class="st1 st2 st3">40.70</text>
							</g>
							<text transform="matrix(1 0 0 1 1132.6058 99.9785)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(1 0 0 1 1137.431 76.5884)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="4.1" y="11.6" class="st4 st5 st6">16A</tspan>
								</text>
							</g>
						</g>
						<g id="A-17_1_" ng-class="nvtCalamanda.inmovablesClassList[16]"
							ng-click="nvtCalamanda.showPropertyData(55, '17A', nvtCalamanda.inmovables[16].idProperty)">
							<polyline id="A-N17_1_" class="property pb-sprite-1"
								points="1250.3,192.7 1184.4,192.9 1183.7,1.1 1249.6,0.9 1250.3,192.7 			" />
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 1206.6917 10.8812)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 1207.3224 188.5159)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<g>
								<text transform="matrix(3.490014e-03 1 -1 3.490014e-03 1188.1116 87.0408)"
									class="st1 st2 st3">40.70</text>
							</g>
							<text transform="matrix(1 0 0 1 1198.5687 99.7461)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(1 0 0 1 1203.3969 76.5884)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="4.1" y="11.6" class="st4 st5 st6">17A</tspan>
								</text>
							</g>
						</g>
						<g id="A-18_1_" ng-class="nvtCalamanda.inmovablesClassList[17]"
							ng-click="nvtCalamanda.showPropertyData(55, '18A', nvtCalamanda.inmovables[17].idProperty)">
							<polyline id="A-N18_1_" class="property pb-sprite-2"
								points="1249.6,0.9 1343.9,0.6 1351.6,192.3 1250.3,192.7 1249.6,0.9 			" />
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 1286.7947 10.5988)">
								<tspan x="0" y="0" class="st1 st2 st3">20.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(1 -3.490014e-03 3.490014e-03 1 1290.936 188.2202)">
								<tspan x="0" y="0" class="st1 st2 st3">21.4</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">9</tspan>
							</text>
							<g>
								<text transform="matrix(3.490014e-03 1 -1 3.490014e-03 1254.0858 86.8076)"
									class="st1 st2 st3">40.70</text>
							</g>
							<g>
								<text transform="matrix(3.839011e-02 0.9993 -0.9993 3.839011e-02 1337.4078 86.8711)"
									class="st1 st2 st3">40.73</text>
							</g>
							<text transform="matrix(1 0 0 1 1282.1703 99.4639)">
								<tspan x="0" y="0" class="st1 st2 st3">84</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">4.27 m2</tspan>
							</text>
							<g>
								<text transform="matrix(1 0 0 1 1285.6263 76.5884)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="4.1" y="11.6" class="st4 st5 st6">18A</tspan>
								</text>
							</g>
						</g>
						<g id="DIVISIONES_3_">
					...
					<g id="ISLA_B">
						<g id="B-1_2_" ng-class="nvtCalamanda.inmovablesClassList[18]"
							ng-click="nvtCalamanda.showPropertyData(55, '1B', nvtCalamanda.inmovables[18].idProperty)">
							<polyline id="B-N1_2_" class="property pb-sprite-2"
								points="194.9,495.1 128.9,495.1 128.9,302.9 194.9,302.9 194.9,495.1 			" />
							<text transform="matrix(0.9984 0 0 1 151.9613 312.8916)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 151.9613 490.8721)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0 -1.0016 1 0 138.7689 408.8525)">
								<tspan x="0" y="0" class="st1 st2 st3">40.7</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 143.4246 401.8838)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(0.9984 0 0 1 148.6873 377.0586)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="7.6" y="11.6" class="st4 st5 st6">1B</tspan>
								</text>
							</g>
							<g>
						...
						<g id="B-2_2_" ng-class="nvtCalamanda.inmovablesClassList[19]"
							ng-click="nvtCalamanda.showPropertyData(55, '2B', nvtCalamanda.inmovables[19].idProperty)">
							<polyline id="B-N2_2_" class="property pb-sprite-1"
								points="260.8,495.1 194.9,495.1 194.9,302.9 260.8,302.9 260.8,495.1 			" />
							<text transform="matrix(0.9984 0 0 1 217.9495 312.8916)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 217.9495 490.8721)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0 -1.0016 1 0 204.7557 408.8525)">
								<tspan x="0" y="0" class="st1 st2 st3">40.7</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 209.4119 401.8838)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(0.9984 0 0 1 214.6741 377.0586)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="7.6" y="11.6" class="st4 st5 st6">2B</tspan>
								</text>
							</g>
						</g>
						<g id="B-3_2_" ng-class="nvtCalamanda.inmovablesClassList[20]"
							ng-click="nvtCalamanda.showPropertyData(55, '3B', nvtCalamanda.inmovables[20].idProperty)">
							<polyline id="B-N3_2_" class="property pb-sprite-2"
								points="326.8,495.1 260.8,495.1 260.8,302.9 326.8,302.9 326.8,495.1 			" />
							<text transform="matrix(0.9984 0 0 1 283.9373 312.8916)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 283.9373 490.8721)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0 -1.0016 1 0 270.7435 408.8525)">
								<tspan x="0" y="0" class="st1 st2 st3">40.7</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 275.3997 401.8838)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(0.9984 0 0 1 280.662 377.0586)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="7.6" y="11.6" class="st4 st5 st6">3B</tspan>
								</text>
							</g>
						</g>
						<g id="B-4_2_" ng-class="nvtCalamanda.inmovablesClassList[21]"
							ng-click="nvtCalamanda.showPropertyData(55, '4B', nvtCalamanda.inmovables[21].idProperty)">
							<polyline id="B-N4_2_" class="property pb-sprite-1"
								points="326.8,495.1 326.8,302.9 392.8,302.9 392.8,495.1 326.8,495.1 			" />
							<text transform="matrix(0.9984 0 0 1 349.9242 312.8916)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 349.9242 490.8721)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0 -1.0016 1 0 336.7313 408.8535)">
								<tspan x="0" y="0" class="st1 st2 st3">40.7</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 341.3871 401.8838)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(0.9984 0 0 1 346.6497 377.0586)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="7.6" y="11.6" class="st4 st5 st6">4B</tspan>
								</text>
							</g>
						</g>
						<g id="B-5_2_" ng-class="nvtCalamanda.inmovablesClassList[22]"
							ng-click="nvtCalamanda.showPropertyData(55, '5B', nvtCalamanda.inmovables[22].idProperty)">
							<polyline id="B-N5_2_" class="property pb-sprite-2"
								points="458.8,495.1 392.8,495.1 392.8,302.9 458.8,302.9 458.8,495.1 			" />
							<text transform="matrix(0.9984 0 0 1 415.9144 312.8916)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 415.9144 490.8721)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0 -1.0016 1 0 402.7191 408.8525)">
								<tspan x="0" y="0" class="st1 st2 st3">40.7</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 407.3739 401.8838)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(0.9984 0 0 1 412.6371 377.0586)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="7.6" y="11.6" class="st4 st5 st6">5B</tspan>
								</text>
							</g>
						</g>
						<g id="B-6_2_" ng-class="nvtCalamanda.inmovablesClassList[23]"
							ng-click="nvtCalamanda.showPropertyData(55, '6B', nvtCalamanda.inmovables[23].idProperty)">
							<polyline id="B-N6_2_" class="property pb-sprite-1"
								points="458.8,495.1 458.8,302.9 524.8,302.9 524.8,495.1 458.8,495.1 			" />
							<text transform="matrix(0.9984 0 0 1 481.9012 312.8916)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 481.9012 490.8721)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0 -1.0016 1 0 468.7054 408.8525)">
								<tspan x="0" y="0" class="st1 st2 st3">40.7</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 473.3631 401.8838)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(0.9984 0 0 1 478.6258 377.0586)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="7.6" y="11.6" class="st4 st5 st6">6B</tspan>
								</text>
							</g>
						</g>
						<g id="B-7_2_" ng-class="nvtCalamanda.inmovablesClassList[24]"
							ng-click="nvtCalamanda.showPropertyData(55, '7B', nvtCalamanda.inmovables[24].idProperty)">
							<polyline id="B-N7_2_" class="property pb-sprite-2"
								points="590.8,495.1 524.8,495.1 524.8,302.9 590.8,302.9 590.8,495.1 			" />
							<text transform="matrix(0.9984 0 0 1 547.886 312.8916)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 547.886 490.8721)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0 -1.0016 1 0 534.6927 408.8525)">
								<tspan x="0" y="0" class="st1 st2 st3">40.7</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 539.3504 401.8838)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(0.9984 0 0 1 544.6146 377.0586)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="7.6" y="11.6" class="st4 st5 st6">7B</tspan>
								</text>
							</g>
						</g>
						<g id="B-8_2_" ng-class="nvtCalamanda.inmovablesClassList[25]"
							ng-click="nvtCalamanda.showPropertyData(55, '8B', nvtCalamanda.inmovables[25].idProperty)">
							<polyline id="B-N8_2_" class="property pb-sprite-1"
								points="590.8,495.1 590.8,302.9 656.8,302.9 656.8,495.1 590.8,495.1 			" />
							<text transform="matrix(0.9984 0 0 1 613.8753 312.8916)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 613.8753 490.8721)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0 -1.0016 1 0 600.6819 408.8525)">
								<tspan x="0" y="0" class="st1 st2 st3">40.7</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 605.3382 401.8838)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(0.9984 0 0 1 610.6009 377.0586)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="7.6" y="11.6" class="st4 st5 st6">8B</tspan>
								</text>
							</g>
						</g>
						<g id="B-9_2_" ng-class="nvtCalamanda.inmovablesClassList[26]"
							ng-click="nvtCalamanda.showPropertyData(55, '9B', nvtCalamanda.inmovables[26].idProperty)">
							<polyline id="B-N9_2_" class="property pb-sprite-2"
								points="656.8,302.9 722.8,302.9 722.8,495.1 656.8,495.1 656.8,302.9 			" />
							<text transform="matrix(0.9984 0 0 1 679.8636 312.8916)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 679.8636 490.8721)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0 -1.0016 1 0 666.6722 408.8525)">
								<tspan x="0" y="0" class="st1 st2 st3">40.7</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 671.3275 401.8838)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(0.9984 0 0 1 676.5901 377.0586)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="7.6" y="11.6" class="st4 st5 st6">9B</tspan>
								</text>
							</g>
						</g>
						<g id="B-10_2_" ng-class="nvtCalamanda.inmovablesClassList[27]"
							ng-click="nvtCalamanda.showPropertyData(55, '10B', nvtCalamanda.inmovables[27].idProperty)">
							<polyline id="B-N10_2_" class="property pb-sprite-1"
								points="788.7,495.1 722.8,495.1 722.8,302.9 788.7,302.9 788.7,495.1 			" />
							<text transform="matrix(0.9984 0 0 1 745.8519 312.8916)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 745.8519 490.8721)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0 -1.0016 1 0 732.6575 408.8535)">
								<tspan x="0" y="0" class="st1 st2 st3">40.7</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 737.3138 401.8838)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(0.9984 0 0 1 742.5794 377.0586)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="4.8" y="11.6" class="st4 st5 st6">10B</tspan>
								</text>
							</g>
						</g>
						<g id="B-11_2_" ng-class="nvtCalamanda.inmovablesClassList[28]"
							ng-click="nvtCalamanda.showPropertyData(55, '11B', nvtCalamanda.inmovables[28].idProperty)">
							<polyline id="B-N11_2_" class="property pb-sprite-2"
								points="854.7,495.1 788.7,495.1 788.7,302.9 854.7,302.9 854.7,495.1 			" />
							<text transform="matrix(0.9984 0 0 1 811.8382 312.8916)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 811.8382 490.8721)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0 -1.0016 1 0 798.6448 408.8535)">
								<tspan x="0" y="0" class="st1 st2 st3">40.7</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 803.2991 401.8838)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(0.9984 0 0 1 808.5657 377.0586)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="4.8" y="11.6" class="st4 st5 st6">11B</tspan>
								</text>
							</g>
						</g>
						<g id="B-12_2_" ng-class="nvtCalamanda.inmovablesClassList[29]"
							ng-click="nvtCalamanda.showPropertyData(55, '12B', nvtCalamanda.inmovables[29].idProperty)">
							<polyline id="B-N12_2_" class="property pb-sprite-1"
								points="920.7,495.1 854.7,495.1 854.7,302.9 920.7,302.9 920.7,495.1 			" />
							<text transform="matrix(0.9984 0 0 1 877.8275 312.8916)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 877.8275 490.8721)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0 -1.0016 1 0 864.6312 408.8525)">
								<tspan x="0" y="0" class="st1 st2 st3">40.7</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 869.2894 401.8838)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(0.9984 0 0 1 874.554 377.0586)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="4.8" y="11.6" class="st4 st5 st6">12B</tspan>
								</text>
							</g>
						</g>
						<g id="B-13_2_" ng-class="nvtCalamanda.inmovablesClassList[30]"
							ng-click="nvtCalamanda.showPropertyData(55, '13B', nvtCalamanda.inmovables[30].idProperty)">
							<polyline id="B-N13_2_" class="property pb-sprite-2"
								points="920.7,302.9 986.7,302.9 986.7,495.1 920.7,495.1 920.7,302.9 			" />
							<text transform="matrix(0.9984 0 0 1 943.8138 312.8916)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 943.8138 490.8721)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0 -1.0016 1 0 930.6185 408.8535)">
								<tspan x="0" y="0" class="st1 st2 st3">40.7</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 935.2737 401.8838)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(0.9984 0 0 1 940.5384 377.0586)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="4.8" y="11.6" class="st4 st5 st6">13B</tspan>
								</text>
							</g>
						</g>
						<g id="B-14_2_" ng-class="nvtCalamanda.inmovablesClassList[31]"
							ng-click="nvtCalamanda.showPropertyData(55, '14B', nvtCalamanda.inmovables[31].idProperty)">
							<polyline id="B-N14_2_" class="property pb-sprite-1"
								points="1052.7,495.1 986.7,495.1 986.7,302.9 1052.7,302.9 1052.7,495.1 			" />
							<text transform="matrix(0.9984 0 0 1 1009.803 312.8916)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 1009.803 490.8721)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0 -1.0016 1 0 996.6068 408.8545)">
								<tspan x="0" y="0" class="st1 st2 st3">40.7</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 1001.263 401.8838)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(0.9984 0 0 1 1006.5257 377.0586)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="4.8" y="11.6" class="st4 st5 st6">14B</tspan>
								</text>
							</g>
						</g>
						<g id="B-15_2_" ng-class="nvtCalamanda.inmovablesClassList[32]"
							ng-click="nvtCalamanda.showPropertyData(55, '15B', nvtCalamanda.inmovables[32].idProperty)">
							<polyline id="B-N15_2_" class="property pb-sprite-2"
								points="1052.7,302.9 1118.7,302.9 1118.7,495.1 1052.7,495.1 1052.7,302.9 			" />
							<text transform="matrix(0.9984 0 0 1 1075.7904 312.8916)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 1075.7904 490.8721)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0 -1.0016 1 0 1062.5961 408.8525)">
								<tspan x="0" y="0" class="st1 st2 st3">40.7</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 1067.2513 401.8838)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(0.9984 0 0 1 1072.514 377.0586)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="4.8" y="11.6" class="st4 st5 st6">15B</tspan>
								</text>
							</g>
						</g>
						<g id="B-16_2_" ng-class="nvtCalamanda.inmovablesClassList[33]"
							ng-click="nvtCalamanda.showPropertyData(55, '16B', nvtCalamanda.inmovables[33].idProperty)">
							<polyline id="B-N16_2_" class="property pb-sprite-1"
								points="1118.7,495.1 1118.7,302.9 1184.7,302.9 1184.7,495.1 1118.7,495.1 			" />
							<text transform="matrix(0.9984 0 0 1 1141.7806 312.8916)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 1141.7806 490.8721)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0 -1.0016 1 0 1128.5785 408.8535)">
								<tspan x="0" y="0" class="st1 st2 st3">40.7</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 1133.2357 401.8838)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(0.9984 0 0 1 1138.5033 377.0586)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="4.8" y="11.6" class="st4 st5 st6">16B</tspan>
								</text>
							</g>
						</g>
						<g id="B-17_2_" ng-class="nvtCalamanda.inmovablesClassList[34]"
							ng-click="nvtCalamanda.showPropertyData(55, '17B', nvtCalamanda.inmovables[34].idProperty)">
							<polyline id="B-N17_2_" class="property pb-sprite-2"
								points="1184.7,302.9 1250.7,302.9 1250.7,495.1 1184.7,495.1 1184.7,302.9 			" />
							<text transform="matrix(0.9984 0 0 1 1207.7631 312.8916)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 1207.7631 490.8721)">
								<tspan x="0" y="0" class="st1 st2 st3">14.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0 -1.0016 1 0 1194.5756 408.8525)">
								<tspan x="0" y="0" class="st1 st2 st3">40.7</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 1199.2299 401.8838)">
								<tspan x="0" y="0" class="st1 st2 st3">56</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">9.80 m2</tspan>
							</text>
							<g>
								<text transform="matrix(0.9984 0 0 1 1204.4867 377.0586)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="4.8" y="11.6" class="st4 st5 st6">17B</tspan>
								</text>
							</g>
						</g>
						<g id="B-18_2_" ng-class="nvtCalamanda.inmovablesClassList[35]"
							ng-click="nvtCalamanda.showPropertyData(55, '18B', nvtCalamanda.inmovables[35].idProperty)">
							<polyline id="B-N18_2_" class="property pb-sprite-1"
								points="1250.7,302.9 1356.4,302.9 1364.1,495.1 1250.7,495.1 1250.7,302.9 			" />
							<text transform="matrix(0.9984 0 0 1 1293.6166 312.8916)">
								<tspan x="0" y="0" class="st1 st2 st3">22.4</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">3</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 1297.4584 490.8721)">
								<tspan x="0" y="0" class="st1 st2 st3">24.0</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">6</tspan>
							</text>
							<g>
								<text transform="matrix(3.839096e-02 1.0008 -0.9993 3.845002e-02 1349.6637 404.9079)"
									class="st1 st2 st3">3</text>
								<text transform="matrix(3.839096e-02 1.0008 -0.9993 3.845002e-02 1349.4945 400.4971)"
									class="st1 st2 st3">7</text>
								<text transform="matrix(3.839096e-02 1.0008 -0.9993 3.845002e-02 1349.4108 398.3122)"
									class="st1 st2 st3">.</text>
								<text transform="matrix(3.839096e-02 1.0008 -0.9993 3.845002e-02 1349.2416 393.9023)"
									class="st1 st2 st3">0</text>
								<text transform="matrix(3.839096e-02 1.0008 -0.9993 3.845002e-02 1349.0715 389.4964)"
									class="st1 st2 st3">4</text>
							</g>
							<text transform="matrix(0 -1.0016 1 0 1260.558 408.8545)">
								<tspan x="0" y="0" class="st1 st2 st3">40.7</tspan>
								<tspan x="16" y="0" class="st1 st2 st3">0</tspan>
							</text>
							<text transform="matrix(0.9984 0 0 1 1288.9271 401.8838)">
								<tspan x="0" y="0" class="st1 st2 st3">94</tspan>
								<tspan x="9.2" y="0" class="st1 st2 st3">6.06 m2</tspan>
							</text>
							<g>
								<text transform="matrix(0.9984 0 0 1 1290.3392 377.0586)">
									<tspan x="0" y="0" class="st4 st5 st6">NAVE</tspan>
									<tspan x="4.8" y="11.6" class="st4 st5 st6">18B</tspan>
								</text>
							</g>
						</g>
						<g id="DIVISIONES_1_">
				...
				<g id="COMPLEMENTO">
					<polygon class="st12"
						points="78.5,319.3 101.3,319.3 101.3,311.2 128.9,311.2 128.9,495.1 78.5,495.1 	" />
					...
					<g>
						<text transform="matrix(-7.229941e-03 -1 1.107 -1.293072e-02 29.5032 287.9663)"
							class="st13 st5 st14">ACCESO</text>
					...
					<g>
						<text transform="matrix(-3.208421e-02 -0.9993 1.1019 -5.604011e-02 36.9674 232.4192)"
							class="st13 st5 st15">SALIDA</text>
		...
		<div style="margin:0 16px">
			<svg version="1.1" id="N.B.P._CALAMANDA" xmlns="http://www.w3.org/2000/svg"
				xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1366 821"
				style="enable-background:new 0 0 1366 821;" xml:space="preserve">
				<style type="text/css">
					.stc0 {
						display: none;
					}
					...
					.stc31 {
						...
						stroke-width: 1.7172;
						stroke-miterlimit: 10;
						stroke-dasharray: 21.0778, 21.0778;
					}
					...
					.stc32 {
						...
						stroke-width: 1.7172;
						stroke-miterlimit: 10;
						stroke-dasharray: 21.0838, 21.0838;
					}
					...
					.stc33 {
						...
						stroke-width: 1.7172;
						stroke-miterlimit: 10;
						stroke-dasharray: 20.8478, 20.8478;
					}
					...
					.stc34 {
						...
						stroke-width: 1.7172;
						stroke-miterlimit: 10;
						stroke-dasharray: 20.7314, 20.7314;
					}
				...
				<g id="MACHOTE" class="stc0">
					<g class="stc1">
						<g>
							<g>
								...
								<path class="stc2"
									d="M2585.8,390.2l-3.3,3.3c-3.4-3.4-7.5-6.2-12.1-8.2l1.8-4.3C2577.3,383.2,2581.9,386.3,2585.8,390.2z" />
								<g>
								...
								<path class="stc2"
									d="M2598.4,419.5l-4.8-1.7c-0.3-4-1.2-7.9-2.7-11.5l4.4-1.8C2597.1,409.2,2598.2,414.2,2598.4,419.5z" />
								<path class="stc2"
									d="M2528.2,393.5c-3.4,3.4-6.2,7.5-8.2,12.1l-4.3-1.8c2.2-5.1,5.3-9.7,9.2-13.6L2528.2,393.5z" />
								<g>
									<path class="stc2"
										d="M2515.9,404.2l3.8,1.6c-1.6,3.7-2.5,7.7-2.8,11.8l-4.2,1.5C2512.8,413.9,2513.9,408.9,2515.9,404.2
            						 M2515.7,403.8c-2.1,4.8-3.3,10.1-3.4,15.7l4.8-1.7c0.3-4.3,1.3-8.4,3-12.2L2515.7,403.8L2515.7,403.8z" />
								</g>
								<g>
									<path class="stc2"
										d="M2539.1,381.1l1.5,3.8c-4.6,1.9-8.8,4.7-12.4,8.2l-2.9-2.9C2529.3,386.3,2533.9,383.2,2539.1,381.1
            						 M2539.2,380.7c-5.4,2.2-10.3,5.4-14.3,9.5l3.3,3.3c3.6-3.6,8-6.5,12.8-8.5L2539.2,380.7L2539.2,380.7z" />
								</g>
								<path class="stc2"
									d="M2554.2,377.6l-1.7,4.8c-4,0.3-7.9,1.2-11.5,2.7l-1.8-4.4C2543.9,378.8,2548.9,377.7,2554.2,377.6z" />
								<g>
								...
								<path class="stc2"
									d="M2595,437.5c-2.2,5.1-5.3,9.7-9.2,13.6l-3.3-3.3c3.4-3.4,6.2-7.5,8.2-12.1L2595,437.5z" />
								<g>
									<path class="stc2"
										d="M2582.5,448.2l2.9,2.9c-4,3.9-8.6,7-13.7,9.1l-1.5-3.8C2574.7,454.5,2578.9,451.7,2582.5,448.2
            						 M2582.5,447.8c-3.6,3.6-8,6.5-12.8,8.5l1.8,4.4c5.4-2.2,10.3-5.4,14.3-9.5L2582.5,447.8L2582.5,447.8z" />
								</g>
								<path class="stc2"
									d="M2571.4,460.6c-4.6,1.9-9.7,3-14.9,3.1l1.7-4.8c4-0.3,7.9-1.2,11.5-2.7L2571.4,460.6z" />
								<g>
								...
								<path class="stc2"
									d="M2540.3,455.9l-1.8,4.3c-5.1-2.2-9.7-5.3-13.6-9.2l3.3-3.3C2531.7,451.2,2535.8,454,2540.3,455.9z" />
								<g>
								...
								<path class="stc2"
									d="M2519.8,435l-4.3,1.8c-1.9-4.6-3-9.7-3.1-14.9l4.8,1.7C2517.4,427.5,2518.3,431.4,2519.8,435z" />
							</g>
							<g>
								<g>
            		...
            		h-3.2V785.9z" />
					<path class="stc4"
						d="M2521.9,799.9h-3.2v-14h3v2.3c0.6-1,1.4-1.7,2.2-2.1c0.8-0.4,1.8-0.7,2.9-0.7c1.1,0,2,0.2,2.7,0.7
					...
					<path class="stc4"
						d="M2558.3,799.9h-3.2v-1.8c-0.6,0.8-1.2,1.4-2,1.8c-0.8,0.4-1.6,0.6-2.6,0.6c-2,0-3.5-0.7-4.7-2
					...
					<path class="stc4"
						d="M2606.5,799.9h-3.2v-14h3v2.3c0.6-1,1.4-1.7,2.2-2.1c0.8-0.4,1.8-0.7,2.9-0.7c1.1,0,2,0.2,2.7,0.7
            		c0.7,0.5,1.3,1.2,1.6,2.1c0.7-1,1.5-1.7,2.4-2.1c0.8-0.4,1.8-0.7,2.8-0.7c0.9,0,1.7,0.2,2.4,0.5c0.7,0.3,1.2,0.8,1.6,1.5
            		c0.2,0.3,0.3,0.7,0.4,1.1c0.1,0.4,0.1,1,0.1,1.8v1.1v8.5h-3.2v-7.2c0-1.9-0.2-3.1-0.6-3.7c-0.4-0.6-1.1-0.9-2.1-0.9
            		c-1.3,0-2.2,0.4-2.7,1.2c-0.5,0.8-0.8,2.2-0.8,4.2v6.4h-3.2v-7.2c0-1.7-0.2-2.9-0.6-3.6c-0.4-0.7-1.1-1-2.2-1
            		c-0.6,0-1.2,0.1-1.7,0.4c-0.5,0.3-0.9,0.7-1.2,1.2c-0.2,0.3-0.3,0.7-0.4,1.2c-0.1,0.5-0.1,1.3-0.1,2.6V799.9z" />
					...
					<path class="stc4"
						d="M2392.8,798.3c0-0.5,0.2-1,0.6-1.4c0.4-0.4,0.8-0.6,1.4-0.6c0.5,0,1,0.2,1.4,0.6c0.4,0.4,0.6,0.8,0.6,1.4
            		c0,0.5-0.2,1-0.6,1.4c-0.4,0.4-0.8,0.6-1.4,0.6c-0.5,0-1-0.2-1.4-0.6C2392.9,799.3,2392.8,798.8,2392.8,798.3" />
					<path class="stc4"
						d="M2563.1,798.3c0-0.5,0.2-1,0.6-1.4c0.4-0.4,0.8-0.6,1.4-0.6c0.5,0,1,0.2,1.4,0.6c0.4,0.4,0.6,0.8,0.6,1.4
						...
						<g>
							<g>
								<g>
									<g>
            							...
            							V745.2z" />
										<path class="stc7"
											d="M1455.1,743.4h-1.6v1.4h1.6v0.2h-1.6v1.8h1.6v0.2h-1.9v-4h1.9V743.4z" />
										<path class="stc7"
											d="M1457.8,747.1v-4l3.3,3.5v-3.5h0.3v4.1l-3.3-3.5v3.4H1457.8L1457.8,747.1z" />
										<path class="stc7"
											d="M1466.2,743.4h-1.6v1.4h1.6v0.2h-1.6v1.8h1.6v0.2h-1.9v-4h1.9V743.4z" />
            							...
            							H1475.2z" />
										<path class="stc7"
											d="M1478.5,747.1v-4l3.3,3.5v-3.5h0.3v4.1l-3.3-3.5v3.4H1478.5L1478.5,747.1z" />
										<path class="stc7"
											d="M1485,747.1v-4h0.8c0.4,0,1,0.1,1.5,0.6c0.4,0.4,0.6,1,0.6,1.4c0,0.4-0.1,1-0.6,1.4
										...
										<path class="stc7"
											d="M1513.2,745.1c0,1.1-0.9,2-2.1,2c-1.2,0-2.1-0.9-2.1-2c0-1.1,0.9-2.1,2.1-2.1S1513.2,744,1513.2,745.1z
										...
										<path class="stc7"
											d="M1528.8,743.4h-1.6v1.4h1.6v0.2h-1.6v1.8h1.6v0.2h-1.9v-4h1.9V743.4z" />
										<path class="stc7"
											d="M1533.3,743.8c-0.2-0.5-0.7-0.5-0.8-0.5c-0.5,0-0.7,0.3-0.7,0.7c0,0.4,0.3,0.6,0.7,0.8
							...
							<g>
								<g>
									<g>
										<path class="stc8"
											d="M1518.8,715.8c-0.7,0.1-1.3-0.2-1.3-0.2l-12.2-6.4c0,0-0.5-0.3-1.1-0.3c-0.4,0-0.9,0.2-1.1,0.3l-2.2,1.2
							...
							<g>
								<g>
									<path class="stc7"
										d="M1458.5,736.3v1.7c-3.3,0-6.1-0.7-8.5-2c-2.3-1.4-3.5-3-3.5-4.9s1.2-3.6,3.5-4.9c2.3-1.4,5.2-2,8.5-2v1.7
            						c-2.4,0-4.4,0.5-6,1.5c-1.7,1-2.5,2.3-2.5,3.7c0,1.4,0.8,2.7,2.5,3.7C1454.2,735.8,1456.2,736.3,1458.5,736.3z" />
								</g>
								<g>
									<path class="stc7"
										d="M1479.8,736.3v1.7c-3.3,0-6.1-0.7-8.5-2c-2.3-1.4-3.5-3-3.5-4.9s1.2-3.6,3.5-4.9s5.2-2,8.5-2v1.7
								...
								<g>
									<path class="stc7"
										d="M1510.4,727.6l5.1-3.5h3.4V738h-3.4v-11.3l-5.1,3.5l-5.1-3.5V738h-3.4v-13.9h3.4L1510.4,727.6z" />
								</g>
								<g>
									<path class="stc7"
										d="M1538.5,726.7v6.1h1.7v1.7h-1.7v3.5h-3.4v-3.5h-3.4v3.5h-3.4v-3.5h-1.7v-1.7h1.7v-6.1
						...
						<g id="Capa_1_3_">
							<g>
								...
								<g>
									<g>
										<path class="stc11"
											d="M2523,121.9h21v5.5h-13.8v8.9h10.6v5.5h-10.6v9.3h15.3v5.7H2523V121.9L2523,121.9z" />
										<path class="stc11" d="M2557.8,127.5h-9.9v-5.5h27v5.5h-9.8v29.3h-7.3V127.5z" />
										<path class="stc11"
											d="M2579.8,121.9h21v5.5H2587v8.9h10.6v5.5H2587v9.3h15.3v5.7h-22.5V121.9z" />
										...
										<path class="stc11"
											d="M2485.9,122h7.7l6.4,19l1.8,6.6l1.9-6.6l6.1-19h7.7l-12.7,34.9h-6.1L2485.9,122z" />
										<path class="stc11"
											d="M2490,156.8h-7.7l-6.4-19l-1.8-6.6l-1.9,6.6l-6.1,19h-7.7L2471,122h6.1L2490,156.8z" />
									</g>
								</g>
								<g>
									<g>
										...
										<path class="stc10"
											d="M2549.9,177.6l-3.1-5.5h0.7l2.7,4.8l2.8-4.8h0.7l-3.2,5.5v4.1h-0.6L2549.9,177.6L2549.9,177.6z" />
										<path class="stc10"
											d="M2576.9,174.1c-0.8-1-2-1.5-3.2-1.5c-2.4,0-4.3,2-4.3,4.4c0,2.8,2.4,4.3,4.3,4.3c1,0,2.2-0.4,3.2-1.4
            							v0.8c-1,0.9-2.1,1.2-3.2,1.2c-2.9,0-5-2.2-5-4.9c0-2.7,2.2-4.9,4.9-4.9c1.8,0,2.9,1,3.2,1.2L2576.9,174.1L2576.9,174.1z" />
										<path class="stc10"
											d="M2591.6,174.1c-0.8-1-2-1.5-3.2-1.5c-2.4,0-4.3,2-4.3,4.4c0,2.8,2.4,4.3,4.3,4.3c1,0,2.2-0.4,3.2-1.4
										...
										<path class="stc10"
											d="M2607.5,181.7l1.1-9.9l4.1,8.8l4.1-8.8l1.1,9.9h-0.6l-0.8-7.7c0,0-3.7,8-3.7,8l-3.7-8l-0.8,7.7H2607.5z" />
					...
					<g id="Capa_2_1_" class="stc1">
						<g>
							<g id="Capa_1-2_8_">
								<g id="Capa_1-2-2_8_">
									<path class="stc6"
										d="M1755,96.4h7.6c2.4-0.1,4.8,0.3,7,1.1c1.6,0.7,3,1.9,3.9,3.3c0.9,1.5,1.4,3.2,1.4,5c0,1.6-0.4,3.3-1.2,4.7
									...
									<path class="stc6"
										d="M1859.3,134.8V96.4h0.8l25.6,29.5V96.4h3.8v38.4h-0.9l-25.3-29.1v29.1H1859.3z" />
									<path class="stc6"
										d="M1898.8,96.4h22v3.8h-18.2v11.9h18v3.8h-18V131h18v3.8h-21.8V96.4z" />
									...
									<path class="stc6"
										d="M1855.2,141.2h3.9v14.4l15.3-14.4h5.2l-18.4,17.2l19.9,21.2h-5.2l-16.8-17.9v17.9h-3.9L1855.2,141.2z" />
									<rect x="1740" y="96.3" class="stc6" width="1.5" height="83.4" />
									<path class="stc6"
										d="M1454.5,96.3h8.7l20.3,31.2V96.3h9v47.3h-8.7l-20.3-31v31h-9V96.3z" />
									<path class="stc6" d="M1513.4,96.3h9.1l18.2,47.3h-9.4l-3.7-9.7h-19.3l-3.8,9.7h-9.4L1513.4,96.3z M1518,108.8l-6.4,16.3h12.7
            						L1518,108.8z" />
									<path class="stc6"
										d="M1536.2,96.3h9.3l11.9,33.6l12.1-33.6h9.3l-17.1,47.3h-8.7L1536.2,96.3z" />
									<path class="stc6"
										d="M1584.3,96.3h25.8v8.8h-16.9v8.6h16.9v8.7h-16.9v12.5h16.9v8.8h-25.8V96.3z" />
									<path class="stc6" d="M1615.2,96.3h26.2v8.9h-8.7v38.4h-9.1v-38.4h-8.4V96.3z" />
									<path class="stc6"
										d="M1646,96.3h25.9v8.8H1655v8.6h16.9v8.7H1655v12.5h16.9v8.8H1646V96.3z" />
									<path class="stc6"
										d="M1722.1,104.6l-6.3,6.1c-3.6-4.3-8.9-6.8-14.5-6.9c-8.7-0.1-15.9,6.8-16.1,15.6v0.5
            						...
            						L1644.9,164.1z" />
									<path class="stc6"
										d="M1659.2,158.5h3.8l9,13.9v-13.9h4v21.1h-3.9l-9-13.9v13.9h-4V158.5z" />
				...
				<g id="BASE">
					<image style="overflow:visible;" width="1366" height="821"
						xlink:href="media/assets/img/navetec/app/calamanda/calamanda_locales.jpg">
					</image>
				</g>
				<g id="LOCALES_PLANTA_BAJA">
					<g id="ISLA_A_1_">
						<g id="A-01_2_">
							...
							<text transform="matrix(0 -1.0026 1 0 16.5749 93.8401)">
								<tspan x="0" y="0" class="stc13 stc14 stc15">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc15">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 29.8503 142.4412)"
								class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(1.0089 0 0 1 29.8503 18.4417)" class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(0.9912 0 0 1 21.8586 86.9915)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6</tspan>
								<tspan x="6.5" y="0" class="stc13 stc14 stc17">6.60 m2</tspan>
							</text>
							<text transform="matrix(1.0026 0 0 1 22.2355 56.0242)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">01</tspan>
							</text>
						</g>
						<g id="A-02_2_">
							<polyline id="A-L02_2_" class="stc21"
								points="160,2.4 160.5,148.4 81.8,148.7 81.3,2.7 			" />
							<text transform="matrix(0 -1.0026 1 0 95.28 93.8401)">
								<tspan x="0" y="0" class="stc13 stc14 stc15">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc15">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 110.9313 142.4412)"
								class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(1.0089 0 0 1 110.9313 18.4417)"
								class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(0.9912 0 0 1 97.6667 86.9915)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6</tspan>
								<tspan x="6.5" y="0" class="stc13 stc14 stc17">6.60 m2</tspan>
							</text>
							<text transform="matrix(1.0026 0 0 1 100.9494 56.0261)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">02</tspan>
							</text>
						</g>
						<g id="A-03_2_">
							<polyline id="A-L03_2_" class="stc12"
								points="238.7,2.1 239.2,148.1 160.5,148.4 160,2.4 			" />
							<text transform="matrix(0 -1.0026 1 0 173.9924 93.8401)">
								<tspan x="0" y="0" class="stc13 stc14 stc15">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc15">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 187.7204 142.4412)"
								class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(1.0089 0 0 1 187.7204 18.4417)"
								class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(0.9912 0 0 1 178.9099 86.9915)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6</tspan>
								<tspan x="6.5" y="0" class="stc13 stc14 stc17">6.60 m2</tspan>
							</text>
							<text transform="matrix(1.0026 0 0 1 179.6608 56.0261)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">03</tspan>
							</text>
						</g>
						<g id="A-04_2_">
							<polyline id="A-L04_2_" class="stc21"
								points="317.4,1.9 317.9,147.9 239.2,148.1 238.7,2.1 			" />
							<text transform="matrix(0 -1.0026 1 0 252.7053 93.8401)">
								<tspan x="0" y="0" class="stc13 stc14 stc15">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc15">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 268.383 142.4412)"
								class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(1.0089 0 0 1 268.383 18.4417)" class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(0.9912 0 0 1 255.423 86.9915)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6</tspan>
								<tspan x="6.5" y="0" class="stc13 stc14 stc17">6.60 m2</tspan>
							</text>
							<text transform="matrix(1.0026 0 0 1 258.363 56.0242)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">04</tspan>
							</text>
						</g>
						<g id="A-05_2_">
							<polyline id="A-L05_2_" class="stc12"
								points="396.1,1.6 396.6,147.6 317.9,147.9 317.4,1.9 			" />
							<text transform="matrix(0 -1.0026 1 0 331.4138 93.8401)">
								<tspan x="0" y="0" class="stc13 stc14 stc15">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc15">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 344.5114 142.4412)"
								class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(1.0089 0 0 1 344.5114 18.4417)"
								class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(0.9912 0 0 1 335.798 86.9915)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6</tspan>
								<tspan x="6.5" y="0" class="stc13 stc14 stc17">6.60 m2</tspan>
							</text>
							<text transform="matrix(1.0026 0 0 1 337.0754 56.0242)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">05</tspan>
							</text>
							<g>
						...
						<g id="A-06_2_">
							<polyline id="A-L06_2_" class="stc21"
								points="512.2,1.2 512.6,84 491.5,84.1 491.7,147.2 396.6,147.6 396.1,1.6 			" />
							<text transform="matrix(0 -1.0026 1 0 412.0832 93.8401)">
								<tspan x="0" y="0" class="stc13 stc14 stc15">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc15">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 437.4714 17.1301)"
								class="stc13 stc14 stc16">8.85</text>
							<text transform="matrix(-3.486438e-03 -1.0018 1 -3.500000e-03 507.1482 55.3553)">
								<tspan x="0" y="0" class="stc13 stc14 stc15">6.3</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc15">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 486.3483 78.6267)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">1.6</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(0 -1.0026 1 0 486.3483 130.5388)">
								<tspan x="0" y="0" class="stc13 stc14 stc15">4.8</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc15">9</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 429.8796 142.4412)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">7.2</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">5</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 424.465 86.9915)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">90.55</tspan>
								<tspan x="29.3" y="0" class="stc13 stc14 stc17"> m2</tspan>
							</text>
							<text transform="matrix(1.0026 0 0 1 424.048 56.0261)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">06</tspan>
							</text>
							<g>
					...
					<g id="ISLA_B_1_">
						<g id="B-07_1_">
							<polyline id="B-L07_1_" class="stc12"
								points="854.5,1.2 854.5,83.1 875.5,83.1 875.5,145.6 970.6,145.6 970.6,1.2 			" />
							<text transform="matrix(1.0089 0 0 1 908.7985 140.0222)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">7.2</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">5</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 898.3078 14.4807)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">8.8</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">5</tspan>
							</text>
							<text transform="matrix(0 -0.9912 1 0 888.0778 128.4954)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">4.8</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc17">0</tspan>
							</text>
							<text transform="matrix(0 -0.9912 1 0 868.3825 52.3787)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6.3</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc17">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 855.1594 78.6267)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">1.6</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 902.2521 86.3069)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">90.55</tspan>
								<tspan x="29.3" y="0" class="stc13 stc14 stc17"> m2</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 901.0158 56.0242)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">07</tspan>
							</text>
							<g>
						...
						<g id="B-08_1_">
							<polyline id="B-L08_1_" class="stc21"
								points="1049.4,1.2 1049.4,145.6 970.6,145.6 970.6,1.2 			" />
							<text transform="matrix(1.0089 0 0 1 995.7521 140.0222)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">6.0</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 995.7521 14.4807)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">6.0</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(0 -0.9912 1 0 984.5241 91.5862)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc17">0</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 990.7311 86.3069)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6</tspan>
								<tspan x="6.5" y="0" class="stc13 stc14 stc17">6.60 m2</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 989.9304 56.0242)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">08</tspan>
							</text>
							<g>
								<polyline class="stc22"
									points="1006.6,110.5 1013.9,117.8 1006.6,125.1 1006.6,110.5 				" />
								<polyline class="stc23"
									points="1006.6,110.5 1006.6,125.1 999.3,117.8 1006.6,110.5 				" />
							</g>
						</g>
						<g id="B-09_1_">
							<polyline id="B-L09_1_" class="stc12"
								points="1128.1,1.2 1128.1,145.6 1049.4,145.6 1049.4,1.2 			" />
							<text transform="matrix(1.0089 0 0 1 1074.4899 140.0212)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">6.0</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 1074.4899 14.4807)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">6.0</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(0 -0.9912 1 0 1062.3868 91.5862)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc17">0</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 1067.0729 86.3069)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6</tspan>
								<tspan x="6.5" y="0" class="stc13 stc14 stc17">6.60 m2</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 1068.673 56.0242)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">09</tspan>
							</text>
						</g>
						<g id="B-10_2_">
							<polyline id="B-L10_1_" class="stc21"
								points="1206.9,1.2 1206.9,145.6 1128.1,145.6 1128.1,1.2 			" />
							<text transform="matrix(1.0089 0 0 1 1153.2374 140.0222)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">6.0</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 1153.2335 14.4807)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">6.0</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(0 -0.9912 1 0 1142.0265 91.5862)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc17">0</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 1148.4747 86.3069)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6</tspan>
								<tspan x="6.5" y="0" class="stc13 stc14 stc17">6.60 m2</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 1147.4244 56.0261)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">10</tspan>
							</text>
						</g>
						<g id="B-11_1_">
							<polyline id="B-L11_1_" class="stc12"
								points="1284.3,1.2 1284.3,145.6 1205.5,145.6 1205.5,1.2 			" />
							<text transform="matrix(1.0089 0 0 1 1230.6666 140.0212)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">6.0</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 1230.6666 14.4807)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">6.0</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(0 -0.9912 1 0 1218.5641 91.5862)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc17">0</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 1223.2496 86.3069)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6</tspan>
								<tspan x="6.5" y="0" class="stc13 stc14 stc17">6.60 m2</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 1224.8502 56.0242)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">11</tspan>
							</text>
						</g>
						<g id="ESPECTACULAR_PB_1_">
            				...
            				1284.9,1.2 			" />
							<polyline id="L-BAÑOS_3_" class="stc26"
								points="1284.9,65.6 1350.3,65.6 1350.3,145.6 1284.9,145.6 1284.9,65.6 			" />
							<text transform="matrix(0.9912 0 0 1 1287.3112 41.468)"
								class="stc18 stc19 stc27">ESPECTACULAR</text>
							<text transform="matrix(0.9912 0 0 1 1294.3917 115.9714)"
								class="stc18 stc19 stc20">BAÑOS</text>
						</g>
						<g id="DIVISIONES_6_">
				...
				<g id="LOCALES_PLANTA_ALTA">
					<g id="ISLA_C">
						<g id="C-12_2_">
							...
							<text transform="matrix(0 -1.0026 1 0 16.5749 552.1467)">
								<tspan x="0" y="0" class="stc13 stc14 stc15">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc15">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 29.8503 600.7542)"
								class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(1.0089 0 0 1 29.8503 476.7493)"
								class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(0.9912 0 0 1 21.8586 545.301)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6</tspan>
								<tspan x="6.5" y="0" class="stc13 stc14 stc17">6.60 m2</tspan>
							</text>
							<text transform="matrix(1.0026 0 0 1 22.2355 514.3313)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">12</tspan>
							</text>
						</g>
						<g id="C-13_2_">
							<polyline id="C-L13_2_" class="stc21"
								points="160,460.7 160.5,606.7 81.8,607 81.3,461 			" />
							<text transform="matrix(0 -1.0026 1 0 95.28 552.1467)">
								<tspan x="0" y="0" class="stc13 stc14 stc15">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc15">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 110.9313 600.7542)"
								class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(1.0089 0 0 1 110.9313 476.7493)"
								class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(0.9912 0 0 1 97.6667 545.301)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6</tspan>
								<tspan x="6.5" y="0" class="stc13 stc14 stc17">6.60 m2</tspan>
							</text>
							<text transform="matrix(1.0026 0 0 1 100.9494 514.3333)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">13</tspan>
							</text>
						</g>
						<g id="C-14_2_">
							<polyline id="C-L14_2_" class="stc12"
								points="238.7,460.4 239.2,606.4 160.5,606.7 160,460.7 			" />
							<text transform="matrix(0 -1.0026 1 0 173.9924 552.1467)">
								<tspan x="0" y="0" class="stc13 stc14 stc15">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc15">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 187.7204 600.7542)"
								class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(1.0089 0 0 1 187.7204 476.7493)"
								class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(0.9912 0 0 1 178.9099 545.301)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6</tspan>
								<tspan x="6.5" y="0" class="stc13 stc14 stc17">6.60 m2</tspan>
							</text>
							<text transform="matrix(1.0026 0 0 1 179.6608 514.3333)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">14</tspan>
							</text>
						</g>
						<g id="C-15_2_">
							<polyline id="C-L15_2_" class="stc21"
								points="317.4,460.2 317.9,606.2 239.2,606.4 238.7,460.4 			" />
							<text transform="matrix(0 -1.0026 1 0 252.7053 552.1467)">
								<tspan x="0" y="0" class="stc13 stc14 stc15">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc15">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 268.383 600.7542)"
								class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(1.0089 0 0 1 268.383 476.7493)"
								class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(0.9912 0 0 1 255.423 545.301)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6</tspan>
								<tspan x="6.5" y="0" class="stc13 stc14 stc17">6.60 m2</tspan>
							</text>
							<text transform="matrix(1.0026 0 0 1 258.363 514.3313)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">15</tspan>
							</text>
						</g>
						<g id="C-16_2_">
							<polyline id="C-L16_2_" class="stc12"
								points="396.1,459.9 396.6,605.9 317.9,606.2 317.4,460.2 			" />
							<text transform="matrix(0 -1.0026 1 0 331.4138 552.1467)">
								<tspan x="0" y="0" class="stc13 stc14 stc15">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc15">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 344.5114 600.7542)"
								class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(1.0089 0 0 1 344.5114 476.7493)"
								class="stc13 stc14 stc16">6.00</text>
							<text transform="matrix(0.9912 0 0 1 335.798 545.301)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6</tspan>
								<tspan x="6.5" y="0" class="stc13 stc14 stc17">6.60 m2</tspan>
							</text>
							<text transform="matrix(1.0026 0 0 1 337.0754 514.3313)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">16</tspan>
							</text>
							<g>
						...
						<g id="C-17_1_">
							<polyline id="C-L17_1_" class="stc21"
								points="512.2,459.5 512.6,542.3 491.5,542.4 491.7,605.5 396.6,605.9 396.1,459.9 			" />
							<text transform="matrix(0 -1.0026 1 0 412.0832 552.1467)">
								<tspan x="0" y="0" class="stc13 stc14 stc15">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc15">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 437.4714 475.4368)"
								class="stc13 stc14 stc16">8.85</text>
							<text transform="matrix(-3.486438e-03 -1.0018 1 -3.500000e-03 507.1469 513.6625)">
								<tspan x="0" y="0" class="stc13 stc14 stc15">6.3</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc15">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 486.3483 536.9319)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">1.6</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(0 -1.0026 1 0 486.3483 588.8489)">
								<tspan x="0" y="0" class="stc13 stc14 stc15">4.8</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc15">9</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 429.8796 600.7542)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">7.2</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">5</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 424.465 545.301)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">90.55</tspan>
								<tspan x="29.3" y="0" class="stc13 stc14 stc17"> m2</tspan>
							</text>
							<text transform="matrix(1.0026 0 0 1 424.048 514.3333)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">17</tspan>
							</text>
							<g>
					...
					<g id="ISLA_D">
						<g id="D-18_1_">
							<polyline id="D-L18_1_" class="stc12"
								points="854.5,459.5 854.5,541.4 875.5,541.4 875.5,603.9 970.6,603.9 970.6,459.5 			" />
							<text transform="matrix(1.0089 0 0 1 908.7985 598.3303)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">7.2</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">5</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 898.3078 472.7854)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">8.8</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">5</tspan>
							</text>
							<text transform="matrix(0 -0.9912 1 0 888.0778 586.802)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">4.8</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc17">0</tspan>
							</text>
							<text transform="matrix(0 -0.9912 1 0 868.3825 510.6848)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6.3</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc17">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 855.1594 536.9319)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">1.6</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 902.2521 544.6135)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">90.55</tspan>
								<tspan x="29.3" y="0" class="stc13 stc14 stc17"> m2</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 901.0158 514.3313)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">18</tspan>
							</text>
							<g>
						...
						<g id="D-19_1_">
							<polyline id="D-L19_1_" class="stc21"
								points="1049.4,459.5 1049.4,603.9 970.6,603.9 970.6,459.5 			" />
							<text transform="matrix(1.0089 0 0 1 995.7521 598.3303)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">6.0</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 995.7521 472.7854)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">6.0</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(0 -0.9912 1 0 984.5241 549.8938)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc17">0</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 990.7311 544.6135)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6</tspan>
								<tspan x="6.5" y="0" class="stc13 stc14 stc17">6.60 m2</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 989.9304 514.3313)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">19</tspan>
							</text>
							<g>
								<polyline class="stc22"
									points="1006.6,570.4 1013.9,577.7 1006.6,585 1006.6,570.4 				" />
								<polyline class="stc23"
									points="1006.6,570.4 1006.6,585 999.3,577.7 1006.6,570.4 				" />
							</g>
						</g>
						<g id="D-20_1_">
							<polyline id="D-L20_1_" class="stc12"
								points="1128.1,459.5 1128.1,603.9 1049.4,603.9 1049.4,459.5 			" />
							<text transform="matrix(1.0089 0 0 1 1074.4899 598.3284)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">6.0</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 1074.4899 472.7854)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">6.0</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(0 -0.9912 1 0 1062.3868 549.8938)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc17">0</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 1067.0729 544.6135)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6</tspan>
								<tspan x="6.5" y="0" class="stc13 stc14 stc17">6.60 m2</tspan>
							</text>
							<text id="LOCAL_20_1_" transform="matrix(0.9912 0 0 1 1068.673 514.3333)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">20</tspan>
							</text>
						</g>
						<g id="D-21_1_">
							<polyline id="D-L21_1_" class="stc21"
								points="1206.9,459.5 1206.9,603.9 1128.1,603.9 1128.1,459.5 			" />
							<text transform="matrix(1.0089 0 0 1 1153.2374 598.3303)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">6.0</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 1153.2335 472.7854)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">6.0</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(0 -0.9912 1 0 1142.0265 549.8938)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc17">0</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 1148.4747 544.6135)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6</tspan>
								<tspan x="6.5" y="0" class="stc13 stc14 stc17">6.60 m2</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 1147.4244 514.3333)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">21</tspan>
							</text>
						</g>
						<g id="D-22_1_">
							<polyline id="D-L22_1_" class="stc12"
								points="1284.9,459.5 1284.9,603.9 1206.2,603.9 1206.2,459.5 			" />
							<text transform="matrix(1.0089 0 0 1 1231.318 598.3284)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">6.0</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(1.0089 0 0 1 1231.318 472.7854)">
								<tspan x="0" y="0" class="stc13 stc14 stc16">6.0</tspan>
								<tspan x="16.2" y="0" class="stc13 stc14 stc16">0</tspan>
							</text>
							<text transform="matrix(0 -0.9912 1 0 1219.2155 549.8938)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">11.1</tspan>
								<tspan x="22.7" y="0" class="stc13 stc14 stc17">0</tspan>
							</text>
							<text transform="matrix(0.9912 0 0 1 1223.901 544.6135)">
								<tspan x="0" y="0" class="stc13 stc14 stc17">6</tspan>
								<tspan x="6.5" y="0" class="stc13 stc14 stc17">6.60 m2</tspan>
							</text>
							<text id="LOCAL_22_1_" transform="matrix(0.9912 0 0 1 1225.5016 514.3333)">
								<tspan x="0" y="0" class="stc18 stc19 stc20">LOCAL</tspan>
								<tspan x="14.5" y="16.5" class="stc18 stc19 stc20">22</tspan>
							</text>
						</g>
						<g id="ESPECTACULAR_PA_1_">
							...
							<polyline id="L-BAÑOS_2_" class="stc26"
								points="1284.9,523.8 1350.3,523.8 1350.3,603.8 1284.9,603.8 1284.9,523.8 			" />
							<text transform="matrix(0.9912 0 0 1 1287.3112 499.7151)"
								class="stc18 stc19 stc27">ESPECTACULAR</text>
							<text transform="matrix(0.9912 0 0 1 1297.2252 553.6116)">
								<tspan x="0" y="0" class="stc18 stc19 stc28">CUARTO</tspan>
								<tspan x="15.5" y="13.4" class="stc18 stc19 stc28">DE</tspan>
								<tspan x="-7.8" y="26.8" class="stc18 stc19 stc28">MÁQUINAS</tspan>
							</text>
						</g>
						<g id="DIVISIONES_1_">
				...
				<g id="COMPLEMENTO">
					<g>
						...
						<g>
							<g>
								...
								<path class="stc13"
									d="M19.1,789.8c0-1.2,0.4-2.2,1.3-3.1c0.9-0.9,1.9-1.3,3.2-1.3c1.2,0,2.3,0.4,3.1,1.3
								...
								<path class="stc13"
									d="M19.4,772v-1.6l5.9-2l-5.9-2v-1.6l8.4-1.4v1.6l-5.3,0.9l5.3,1.8v1.4l-5.3,1.8l5.3,0.9v1.6L19.4,772z" />
							</g>
						</g>
					</g>
					<path class="stc29"
						d="M3.1,628.1c178.2-0.5,356.4-1,534.7-1.5c-0.8-55.8-1.5-111.5-2.3-167.3c98.1-0.2,196.2-0.5,294.3-0.7
					...
					<g>
						<text transform="matrix(0.9993 -3.208422e-02 5.604016e-02 1.1019 584.6485 272.6408)"
							class="stc7 stc19 stc36">SALIDA</text>
					...
					<g>
						<text transform="matrix(1 -7.229928e-03 1.293069e-02 1.107 727.3293 292.1205)"
							class="stc7 stc19 stc37">ACCESO</text>
					...
					<g>
						...
						<g>
							<g>
								...
								<path class="stc13"
									d="M19.4,311.2v-1.6l5.9-2l-5.9-2V304l8.4-1.4v1.6l-5.3,0.9l5.3,1.8v1.4l-5.3,1.8l5.3,0.9v1.6L19.4,311.2z" />
							</g>
						</g>
					</g>
				</g>
