...
class Model {
	 ...
	 * @return $response
	 */
	public function insertPhone($phone, $idCountryCode, $idPhoneType, $user, $profile) {
		$insertPhoneResponse = $this->insertABCDE('phones', 'phone', $phone, 'idCountryCode', $idCountryCode, 'idPhoneType', $idPhoneType, 'user', $user, 'profile', $profile, 'siiii');
